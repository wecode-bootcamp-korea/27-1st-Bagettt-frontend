# PROJECT BAGETTT 소개
이번 프로젝트는 기존 가구 렌탈 사이트인 겟트를 조금 각색하여 바겟트라고 명명하였고 전국 빵 맛집의 대표 빵들이 묶여있는 패키지 구독 서비스이다. 프로젝트 예정기간은 총 2주로 잡았으며 첫 프로젝트인 만큼 여러 많은 기능 구현들이나 css의 요소보다 로그인,회원가입, 제품리스트페이지, 상세페이지,장바구니,주문완료 페이지 기능 구현을 목표로 잡았다. 팀원의 경우에는 총 5명으로 프론트엔드 3명 백엔드 2명으로 구성돼있다.
